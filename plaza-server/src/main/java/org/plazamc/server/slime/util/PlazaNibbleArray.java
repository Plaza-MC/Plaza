 ...
 */
public class PlazaNibbleArray {

    private final byte[] backing;

    public PlazaNibbleArray(int size) {
        this(new byte[size / 2]);
    }

    public PlazaNibbleArray(byte[] backing) {
    ...
    public PlazaNibbleArray clone() {
        return new PlazaNibbleArray(this.backing.clone());
    }
}
