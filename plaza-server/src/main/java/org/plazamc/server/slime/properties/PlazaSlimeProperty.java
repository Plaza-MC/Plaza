 ...
 */
public abstract class PlazaSlimeProperty<T, Z extends BinaryTag> {

    private final String key;
    private final T defaultValue;
    private final Function<T, Boolean> validator;

    protected PlazaSlimeProperty(String key, T defaultValue) {
        this(key, defaultValue, null);
    }

    protected PlazaSlimeProperty(String key, T defaultValue, Function<T, Boolean> validator) {
        this.key = key;
